  ...
  return (
    <div className="social-menu-container" ref={menuRef}>
      ...
      <MagneticIcon
        ...
        className="social-item"
        style={{ '--angle': '342deg', '--hover-bg': '#000', '--hover-fill': '#fff' }}
      >
      ...
      <MagneticIcon
        ...
        className="social-item"
        style={{ '--angle': '54deg', '--hover-bg': '#8c9eff', '--hover-fill': '#fff' }}
      >
        <svg viewBox="0 0 16 16" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
      ...
      <MagneticIcon
        ...
        className="social-item"
        style={{ '--angle': '126deg', '--hover-bg': '#1db954', '--hover-fill': '#000' }}
      >
        <svg viewBox="0 0 16 16" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
      ...
      <MagneticIcon
        ...
        className="social-item"
        style={{ '--angle': '198deg', '--hover-bg': '#EA4335', '--hover-fill': '#fff' }}
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
